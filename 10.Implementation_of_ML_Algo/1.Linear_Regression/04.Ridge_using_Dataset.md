## Implementation of the Ridge using the Datset of the Algeria Forrest Fire Prediction
...
# Step 1: Ridge Regression Implementation
# Initialize y_train as a column vector if not already
...
learning_rate = 0.01
n_epochs = 1000
lambda_reg = 0.1  # Regularization parameter (L2 regularization strength)

# Training with Gradient Descent (Ridge Regression)
for epoch in range(n_epochs):
    y_pred = X_b.dot(weights)
    error = y_pred - y_train

    # Gradient for Ridge Regression with L2 Regularization
